...
[^1]:“図説 メイドインアビス探窟記録 MADE IN ABYSS OFFICIAL ART WORK 特設サイト｜WEBコミックガンマ 公式サイト.” Webコミックガンマ, Made in abyss background art work "narakumon" https://webcomicgamma.takeshobo.co.jp/special/abyss_artwork/. Accessed 10 March 2023.
...
|       2 	| Find success criteria and get apply from bernerd   	| Write proposed solution and success criteria.                                                                                                        	| 20m           	|                  Feb20 	| A         	|
...
|       7 	| Create page to add note                            	| Program the kivymd and python files for the GUI and functionality of the note add page                                                               	| 1h            	|                  Feb20 	| C         	|
|       8 	| Create page to edit note                           	| Program the kivymd and python files for the GUI and functionality of the note edit page                                                              	| 30m           	|                  Feb20 	| C         	|
|       9 	| Create system to get color                         	| Program the python file for functionality to get the color with color code and some of color with str.(eg:red, green, purple, white, b, Orange, ...) 	| 4h            	|                  Feb20 	| C         	|
|      10 	| Create system to find complementary color          	| Program the python function to find complementary color and apply to text.                                                                           	| 1h            	|                  Feb20 	| C         	|
|      11 	| Create 80 buttons for substitution of MDDataTable. 	| Program the kivymd and python files for the GUI and functionality to see the all tasks in main page. I can't use MDDatatable.                        	| 5h            	|                  Feb20 	| C         	|
|      12 	| Let buttons able to change colors                  	| Let button to be able to change background color and text color                                                                                      	| 20m           	|                  Feb20 	| C         	|
|      13 	| Make the GUI it bit clean                          	| Program the kivymd for GUI able to see a bit better way.                                                                                             	| 10m           	|                  Feb20 	| C         	|
|      14 	| Second meeting with cliant                         	| Let cliant see the prototype and get approval.                                                                                                       	| 10m           	|                  Feb27 	| A         	|
|      15 	| Be able to use MDColorPicker and  MDDatePicker     	| Ask to ChatGPT, and install something strange to be able to use all of the program.                                                                  	| 5m            	|                  Feb27 	| N/A       	|
|      17 	| Delete everything                                  	| Delete all of the data that I made in Kivymd and Python                                                                                              	| 20sec         	|                  Feb27 	| N/A       	|
|      16 	| Code MDDataTable                                   	| Code MDDataTable and test it is really able to use it or not.                                                                                        	| 30m           	|                  Feb27 	| C         	|
|      18 	| Create login page                                  	| Program the kivymd and python files for the GUI and functionality of the login page                                                                  	| 20m           	|                  Feb27 	| C         	|
|      19 	| Create registration page                           	| Program the kivymd and python files for the GUI and functionality of the registration page                                                           	| 10m           	|                  Feb27 	| C         	|
|      20 	| Create Main page                                   	| Program the kivymd and python files for the GUI and functionality of the main page                                                                   	| 2h            	|                  Feb27 	| C         	|
|      21 	| Test check box                                     	| Try to make a check box for the category selection                                                                                                   	| 30m           	|                  Feb27 	| C         	|
|      22 	| Create page to add note                            	| Program the kivymd and python files for the GUI and functionality of the note add page                                                               	| 1h            	|                  Feb27 	| C         	|
|      23 	| Create page to edit note                           	| Program the kivymd and python files for the GUI and functionality of the note edit page                                                              	| 30m           	|                  Feb27 	| C         	|
|      24 	| Create page to see all tasks with MDDataTable      	| Program the kivymd and python files for the GUI and functionality of to see all of the data using MDDataTable                                        	| 1.5h          	|                   Mar3 	| C         	|
|      25 	| Let MDDataTable directly move to Editingscreen     	| Program python that can directry move to Editingscreen if I press one of task shown.                                                                 	| 30min         	|                   Mar3 	| C         	|
|      26 	| Create MDColorPicker                               	| Program the kivymd and python files for the GUI and functionality to select color easelly.                                                           	| 1h            	|                   Mar3 	| C         	|
|      27 	| Create MDdatepicker                                	| Program the kivymd and python files for the GUI and functionality to select date easelly.                                                            	| 30m           	|                   Mar3 	| C         	|
|      28 	| Create MDCheckbox                                  	| Program the kivymd and python files for the GUI and functionality to select category easelly.                                                        	| 1h            	|                   Mar3 	| C         	|
|      29 	| Apply those to add page                            	| let MDColorPicker, MDDatepicker, MDCheckbox use in add page.                                                                                         	| 30m           	|                   Mar3 	| C         	|
|      30 	| Write Proposed Solution                            	| Write proposed solution.                                                                                                                             	| 2h            	|                   Mar3 	| A         	|
|      31 	| Apply those to edit page                           	| let MDColorPicker, MDDatepicker, MDCheckbox use in edit page.                                                                                        	| 40m           	|                   Mar3 	| C         	|
|      32 	| Third meeting with cliant                          	| Let cliant see the prototype and get approval.                                                                                                       	| 15m           	|                   Mar3 	| A         	|
|      33 	| Write UML diagram                                  	| Draw UML diagram with my PC.                                                                                                                         	| 40m           	|                   Mar8 	| B         	|
|      34 	| Write wireframe diagram                            	| Draw wireflame with whitebord                                                                                                                        	| 20m           	|                   Mar8 	| B         	|
|      35 	| Write System diagram                               	| Draw sustem diagram with my PC.                                                                                                                      	| 40m           	|                   Mar8 	| B         	|
|      36 	| Write flow diagrams                                	| Draw flow diagrams with whitebord                                                                                                                    	| 1h            	|                   Mar8 	| B         	|
|      37 	| Write the comment of the python code               	| Write explanation and comments of the code in python.                                                                                                	| 1.5h          	|                   Mar8 	| C         	|
|      38 	| Make the code clean                                	| Make kivy for GUI to make more clean and organised.                                                                                                  	| 30m           	|                   Mar8 	| C         	|
|      39 	| Take a video.                                      	| Take a demonstration video.                                                                                                                          	| 40m           	|                   Mar8 	| D         	|
|      40 	| Edit a video                                       	| Edit a demonstration video                                                                                                                           	| 20m           	|                   Mar8 	| D         	|
